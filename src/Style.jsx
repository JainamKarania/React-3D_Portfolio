const Style = {
    ...
    sectionHeadText : "font-black text-white md:text-[60px] sm:text-[50px] xs:text-[40px] text-[30px]",
    sectionSubText : "sm:text-[18px] xs:text-[14px] text-secondary uppercase tracking-wider",
};
